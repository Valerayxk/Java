...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SavingBF1 = new javax.swing.JButton();
        ...
        SavingJSON = new javax.swing.JButton();
        LoadJSON = new javax.swing.JButton();

        jButton1.setText("jButton1");

        SavingBF1.setText("Сохранение");
        SavingBF1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SavingBF1ActionPerformed(evt);
            }
        });
        ...
        SavingJSON.setText("Сохранение");
        SavingJSON.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SavingJSONActionPerformed(evt);
            }
        });

        LoadJSON.setText("Загрузка");
        LoadJSON.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                LoadJSONActionPerformed(evt);
            }
        });
 ...
 DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        ...
        for (int row = 0; row < model.getRowCount(); row++) {
            double lowerLimit = (double) model.getValueAt(row, 0);
            double upperLimit = (double) model.getValueAt(row, 1);
            double step = (double) model.getValueAt(row, 2);
            ...
            try (DatagramSocket serverSocket = new DatagramSocket(SERVER_PORT)) {
                for (int i = 0; i < NUM_CLIENTS; i++) {
                    double clientLowerLimit = lowerLimit + i * range;
                    ...
                    DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, clientAddress, CLIENT_PORTS[i]);
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Ошибка при отправке/получении данных!", "Ошибка", JOptionPane.ERROR_MESSAGE);
            }
        }
            long endTime = System.nanoTime();
    System.out.printf("Total execution time of all threads: %.2f ms\n", (endTime - startTime) / 1_000_000.0);
    ...
    private void SavingBF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavingBF1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SavingBF1ActionPerformed

    private void SavingJSONActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavingJSONActionPerformed
       JFileChooser fileChooser = new JFileChooser();
    fileChooser.setDialogTitle("Сохранить в JSON формате");
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        try (FileWriter writer = new FileWriter(fileToSave)) {
            ...
            String json = gson.toJson(integrals);
            writer.write(json);
            
            JOptionPane.showMessageDialog(NewJFrame.this, 
                "Данные успешно сохранены в JSON!", "Успех", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(NewJFrame.this, 
                "Ошибка при сохранении JSON файла!", "Ошибка", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    }//GEN-LAST:event_SavingJSONActionPerformed

    private void LoadJSONActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadJSONActionPerformed
     JFileChooser fileChooser = new JFileChooser();
    fileChooser.setDialogTitle("Загрузить из JSON формата");
    fileChooser.setFileFilter(new FileNameExtensionFilter("JSON файлы (*.json)", "json"));
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        try (FileReader reader = new FileReader(fileToLoad)) {
            ...
            java.lang.reflect.Type type = new com.google.gson.reflect.TypeToken<ArrayList<RecIntegral>>(){}.getType();
            
            ArrayList<RecIntegral> loadedIntegrals = gson.fromJson(reader, type);
            
            integrals.clear();
            integrals.addAll(loadedIntegrals);
            ...
            JOptionPane.showMessageDialog(NewJFrame.this, 
                "Данные успешно загружены из JSON!", "Успех", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(NewJFrame.this, 
                "Ошибка при загрузке JSON файла!", "Ошибка", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    }//GEN-LAST:event_LoadJSONActionPerformed
    ...
    private javax.swing.JButton LoadJSON;
    private javax.swing.JButton SavingBF;
    private javax.swing.JButton SavingBF1;
    private javax.swing.JButton SavingF;
    private javax.swing.JButton SavingJSON;
